    ...
    <AnimatePresence>
      {available && (
        <motion.button
          ...
          className="group fixed bottom-24 left-4 z-[170] grid h-12 w-12 place-items-center rounded-full border border-old-gold/45 bg-cream/70 backdrop-blur-md transition-colors hover:border-old-gold sm:bottom-28 sm:left-6"
        >
