...
export default function Navbar() {
  ...
  return (
    <motion.header
      ...
      className={cn(
        "fixed inset-x-0 top-0 z-[200] border-b backdrop-blur-xl transition-all duration-700",
        scrolled
          ? "border-gold-light/20 bg-[var(--bar-bg-strong)]"
          : "border-gold-light/10 bg-[var(--bar-bg)]",
      )}
    >
